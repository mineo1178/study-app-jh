...
export const calculateGuardedDamage = ({ baseDamage, damageReductionPercent }) => Math.max(1, Math.floor(Math.max(1, Number(baseDamage) || 0) * (100 - Math.max(0, Number(damageReductionPercent) || 0)) / 100));
