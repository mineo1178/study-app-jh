...
describe('equipment catalog', () => {
  it('provides versioned shop and alchemy equipment', () => {
    expect(EQUIPMENT_CATALOG_VERSION).toBe(2);
    expect(Object.keys(EQUIPMENT_CATALOG)).toHaveLength(18);
    for (const item of Object.values(EQUIPMENT_CATALOG)) {
      ...
      if (item.cost) { expect(item.cost.gold).toBeGreaterThanOrEqual(0); expect(item.cost.materials).toEqual(expect.any(Object)); }
