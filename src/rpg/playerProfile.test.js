...
describe('player profile v2', () => {
  ...
  it('upgrades v4 profiles while preserving RPG state and starter unlocks', () => {
    ...
    expect(profile).toMatchObject({ schemaVersion: 6, gold: 55, materials: { iron: 3 }, ownedEquipment: { iron_sword: {} }, totalExp: 30, activeBattleId: 'battle-1', partyMemberIds: ['hero', 'mage'] });
